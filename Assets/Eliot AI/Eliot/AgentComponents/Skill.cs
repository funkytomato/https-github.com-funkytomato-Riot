...
namespace Eliot.AgentComponents
{
	...
	public class Skill : ScriptableObject
	{
        ...
        [SerializeField] private bool _affectIntoxication;
        [SerializeField] private AffectionWay _intoxicationAffectionWay;
        [SerializeField] private bool _affectMorale;
        [SerializeField] private AffectionWay _moraleAffectionWay;
        [SerializeField] private bool _affectTemperament;
        [SerializeField] private AffectionWay _temperamentAffectionWay;
		...
		public Skill Clone()
		{
            ...
            result._affectIntoxication = _affectIntoxication;
            result._intoxicationAffectionWay = _intoxicationAffectionWay;
            result._affectMorale = _affectMorale;
            result._moraleAffectionWay = _moraleAffectionWay;
            result._affectTemperament = _affectTemperament;
            result._temperamentAffectionWay = _temperamentAffectionWay;
		...
		private void INTERNAL_ApplyEffect(Agent targetAgent)
		{
            ...
            if (_affectIntoxication)
            {
                switch (_intoxicationAffectionWay)
                {
                    case AffectionWay.Reduce:
                        targetAgent.Resources.UseIntoxication(hitPower);
                        break;
                    case AffectionWay.Add:
                        targetAgent.Resources.AddIntoxication(hitPower);
                        break;
                }
            }
            ...
            if (_affectMorale)
            {
                switch (_moraleAffectionWay)
                {
                    case AffectionWay.Reduce:
                        targetAgent.Resources.UseMorale(hitPower);
                        break;
                    case AffectionWay.Add:
                        targetAgent.Resources.AddMorale(hitPower);
                        break;
                }
            }

            if (_affectTemperament)
            {
                switch (_temperamentAffectionWay)
                {
                    case AffectionWay.Reduce:
                        targetAgent.Resources.UseTemperament(hitPower);
                        break;
                    case AffectionWay.Add:
                        targetAgent.Resources.AddTemperament(hitPower);
                        break;
                }
            }
