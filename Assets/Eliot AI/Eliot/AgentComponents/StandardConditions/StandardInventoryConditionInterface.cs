...
namespace Eliot.AgentComponents
{
    ...
    public class StandardInventoryConditionInterface : InventoryConditionInterface
    {
        ...
        /// <summary>
        /// Check wheather the Agent has a better projectile in his inventory than the currently wielded one.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool HaveBetterProjectile()
        {
            return _inventory.HaveBetterItem(ItemType.Projectile);
        }
