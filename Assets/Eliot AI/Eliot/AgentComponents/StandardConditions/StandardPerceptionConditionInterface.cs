...
namespace Eliot.AgentComponents
{
    ...
    public class StandardPerceptionConditionInterface : PerceptionConditionInterface
    {
        ...
        /// <summary>
        /// Return true if Agent can see a Unit with low energy.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetHasLowEnergy()
        {
            return _perception.SeeUnit(unit => unit.GetComponent<Agent>().Resources.EnergyPoints
                                      <= unit.GetComponent<Agent>().GeneralSettings.LowEnergy);
        }

        /// <summary>
        /// Return true if Agent can see a Unit with maximum energy.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetHasFullEnergy()
        { return _perception.SeeUnit(unit => unit.GetComponent<Agent>().Resources.EnergyFull()); }

        /// <summary>
        /// Return true if Agent can see a Unit with energy lower than maximum.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetNotFullyEnergy()
        { return _perception.SeeUnit(unit => !unit.GetComponent<Agent>().Resources.EnergyFull()); }


        /// <summary>
        /// Return true if Agent can see a Unit with low morale.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetHasLowMorale()
        {
            return _perception.SeeUnit(unit => unit.GetComponent<Agent>().Resources.MoralePoints
                                      <= unit.GetComponent<Agent>().GeneralSettings.LowMorale);
        }

        /// <summary>
        /// Return true if Agent can see a Unit with maximum morale.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetHasFullMorale()
        { return _perception.SeeUnit(unit => unit.GetComponent<Agent>().Resources.MoraleFull()); }

        /// <summary>
        /// Return true if Agent can see a Unit with morale lower than maximum.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetNotFullyMorale()
        { return _perception.SeeUnit(unit => !unit.GetComponent<Agent>().Resources.MoraleFull()); }

        /// <summary>
        /// Return true if Agent can see a Unit with low temperament.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetHasLowTemperament()
        {
            return _perception.SeeUnit(unit => unit.GetComponent<Agent>().Resources.TemperamentPoints
                                      <= unit.GetComponent<Agent>().GeneralSettings.LowTemperament);
        }

        /// <summary>
        /// Return true if Agent can see a Unit with maximum temperament.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetHasFullTemperament()
        { return _perception.SeeUnit(unit => unit.GetComponent<Agent>().Resources.TemperamentFull()); }
        ...
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetNotFullyTemperament()
        { return _perception.SeeUnit(unit => !unit.GetComponent<Agent>().Resources.TemperamentFull()); }

        /// <summary>
        /// Return true if Agent can see a Unit with low intoxication.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetHasLowIntoxication()
        {
            return _perception.SeeUnit(unit => unit.GetComponent<Agent>().Resources.IntoxicationPoints
                                      <= unit.GetComponent<Agent>().GeneralSettings.LowIntoxication);
        }

        /// <summary>
        /// Return true if Agent can see a Unit with maximum intoxication.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool TargetHasFullIntoxication()
        { return _perception.SeeUnit(unit => unit.GetComponent<Agent>().Resources.IntoxicationFull()); }

        /// <summary>
        /// Return true if Agent can see a Unit with toxication lower than maximum.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        ...
        /// <summary>
        /// Return true if the Agent can see a projectile that is better than the currently wielded one.
        /// </summary>
        /// <returns></returns>
        [IncludeInBehaviour]
        public bool SeeBetterProjectile()
        {
            return _perception.SeeUnit(unit => unit && unit.Type == Environment.UnitType.Item
                                              && unit.GetComponent<Item>().Type == ItemType.Projectile
                                              && _agent.Inventory.ItemIsBetterThanCurrent(unit.GetComponent<Item>()));
        }
        ...
        /// <summary>
        /// Return true if Agent can see any Item that is a potion.
        /// </summary>
        /// /// <returns></returns>
        [IncludeInBehaviour]
        public bool SeePotion()
        {
            return _perception.SeeUnit(unit => unit && unit.Type == Environment.UnitType.Item
