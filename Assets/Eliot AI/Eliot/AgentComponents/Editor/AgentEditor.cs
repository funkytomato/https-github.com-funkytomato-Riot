...
namespace Eliot.AgentComponents.Editor
{
	...
	public class AgentEditor : UnityEditor.Editor
	{
		...
		private void OnSceneGUI_Resources()
		{
            ...
            var intoxicationLabel = _agent.Resources.UsesIntoxication ? ("Max intoxication: " + _agent.Resources.MaxIntoxicationPoints) : "";
            var curIntoxicationLabel = _agent.Resources.UsesIntoxication ? ("Intoxication: " + _agent.Resources.IntoxicationPoints) : "";
            var moraleLabel = _agent.Resources.UsesMorale ? ("Max morale: " + _agent.Resources.MaxMoralePoints) : "";
            var curMoraleLabel = _agent.Resources.UsesMorale ? ("Morale: " + _agent.Resources.MoralePoints) : "";
            var temperamentLabel = _agent.Resources.UsesTemperament ? ("Max temperament: " + _agent.Resources.MaxTemperamentPoints) : "";
            var curTemperamentLabel = _agent.Resources.UsesTemperament ? ("Temperament: " + _agent.Resources.TemperamentPoints) : "";



            Drawlabel(healthLabel, Color.white, -100f);
			Drawlabel(curHealthLabel, Color.white, -85f);
			Drawlabel(energyLabel, Color.white, -70f);
			Drawlabel(curEnergyLabel, Color.white, -55f);
            Drawlabel(intoxicationLabel, Color.white, -40f);
            Drawlabel(curIntoxicationLabel, Color.white, -25f);
            Drawlabel(moraleLabel, Color.white, -10f);
            Drawlabel(curMoraleLabel, Color.white, 5f);
            Drawlabel(temperamentLabel, Color.white, 20f);
            Drawlabel(curTemperamentLabel, Color.white, 35f);
        }
